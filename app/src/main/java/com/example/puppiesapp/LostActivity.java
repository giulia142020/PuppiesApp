...
public class LostActivity extends AppCompatActivity {
    ...
    EditText nome_do_animalEt, racaEt,infoEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infoEt = findViewById(R.id.infoextraEt);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LostActivity.this, DashboardActivity.class));
                finish();
            }
        });
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String infoextra = infoEt.getText().toString().trim();
                String tags;

                if(TextUtils.isEmpty(nome_do_animal)){
                    Toast.makeText(LostActivity.this, "Enter nome ...", Toast.LENGTH_SHORT).show();
                    return ;
                }
                if(!caoRb.isChecked() && !gatoRb.isChecked() ){
                    Toast.makeText(LostActivity.this, "Inserir tipo de animal...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!femeaRb.isChecked() && !machoRb.isChecked()){
                    Toast.makeText(LostActivity.this, "Inserir sexo do animal...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!claroRb.isChecked() && !escuroRb.isChecked() && !mesticoRb.isChecked()){
                    Toast.makeText(LostActivity.this, "Inserir cor do pelo do animal...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(raca)){
                    Toast.makeText(LostActivity.this, "Inserir raça ...", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(image_uri==null)
                {
                    uploadData(nome_do_animal,raca, infoextra,tags,"noImage");
                }else{
                    uploadData(nome_do_animal,raca,infoextra, tags, String.valueOf(image_uri));
    ...
    private void uploadData(final String nome_do_animal, final String raca,final String infoextra, final String tags,  String uri) {
        pd.setMessage("Publicando animal");
        pd.show();
        final String  timeStamp = String.valueOf(System.currentTimeMillis());
        String filePathAndName = "PostsLost/" +"postlost_" + timeStamp;
            ...
            ref.putFile(Uri.parse(uri)).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if(uriTask.isSuccessful()){
                        ...
                        hashMap.put("infoextra",infoextra);
                        ...
                        ref.child(timeStamp).setValue(hashMap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        pd.dismiss();
                                        Toast.makeText(LostActivity.this, "Post publicado", Toast.LENGTH_SHORT).show();
