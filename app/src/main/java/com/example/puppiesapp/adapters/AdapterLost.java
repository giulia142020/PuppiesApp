...
public class AdapterLost extends RecyclerView.Adapter<AdapterLost.MyHolder> {
    Context context;
    List<ModelLost> postList;

    String myUid;

    public AdapterLost(Context context, List<ModelLost> postList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_lost, parent,false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
        ...
        String infoextra= postList.get(position).getInfoextra();
        ...
        holder.infoExtra.setText(infoextra);
   ...
   holder.morebtn.setOnClickListener(new View.OnClickListener() {
       ...
       public void onClick(View view) {
        ...
        holder.encontreiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public  void showMoreOptions(ImageButton  moreBtn, String uid, String myUid, final String pId, final String pImage){
    ...
    private void deleteWithImage(final String pId, String pImage) {
        ...
        picRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Query fquery = FirebaseDatabase.getInstance().getReference("PostsLost").orderByChild("pId").equalTo(pId);
    ...
    class  MyHolder extends RecyclerView.ViewHolder{
        ...
        TextView uNameTv, pTimeTv, pNome_do_animalTv, pRacaTv, pTipoTv, pSexoTv, pCorTv,infoExtra;
        Button encontreiBtn;
        ImageButton morebtn;
        ...
        public  MyHolder(@NonNull View itemView){
            ...
            encontreiBtn =itemView.findViewById(R.id.encontreiBtn);
            profileLayout =itemView.findViewById(R.id.profileLayout);
            infoExtra = itemView.findViewById(R.id.infoextraEt);
